...
<v-container fluid>
    ...
    <v-data-table :headers="headers" :items="gallery" class="elevation-1" :loading="loading" loading-text="Loading.....Please wait.">
        <template v-slot:top>
            <v-toolbar flat color="white">
                <v-toolbar-title>Gallery Management</v-toolbar-title>
                <v-divider class="mx-4" inset vertical></v-divider>
                <v-spacer></v-spacer>
                <!--add new Gallery-->
                <v-dialog v-model="galleryDialog" max-width="1200px" persistent>
        ...
        deleteItem(item) {
            ...
            axios
                ...
                .then(res => {
                    ...
                    this.dataUpdateMsg = "Gallery deleted successfully"
        ...
        save() {
            if (this.$refs.form.validate()) {
                ...
                if (this.editedIndex > -1) {
                    axios
                        .put("/api/gallery/" + this.editedItem.id, {
                            'tag': this.editedItem.tag,
                        })
                        .then(res => {
                            this.gallery.splice(this.gallery.indexOf(this.selectedItem), 1, res.data)
                            this.close();
                            this.$refs.form.reset();
                            this.dataUpdateMsg = "Gallery updated successfully.";
                            this.dataUpdateAlert = true;
                    ...
                    axios
                        ...
                        .then(res => {
                            ...
                            this.close();
                            this.dataUpdateMsg = "New Image added to gallery."
                            this.dataUpdateAlert = true
                            this.$refs.form.reset()
                        })
                        .catch(err => {
